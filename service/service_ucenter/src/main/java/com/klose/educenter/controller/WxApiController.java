...
import com.klose.educenter.utils.ConstantWxUtils;
import com.klose.educenter.utils.HttpClientUtils;
...
public class WxApiController {
    ...
    public String callback(String code,String state) {
        try {
            //获取code值
            //根据code值请求微信固定的地址，得到两个值 accsess_token 和 openid
            ...
            //最后：返回首页面，通过路径传递token字符串 redirect重定向到相应的地址(不能用@RestController注解，
